    ...
    <nav class="nav has-shadow">
      <div class="container">
        <div class="nav-left">
          ...
          <a href="index.php" class="nav-item is-tab is-hidden-mobile is-active">Home</a>
      ...
      <div class="container">
        ...
        <div class="column is-9">
          <div class="container">
            ...
            <div class="columns">
              <?php
                $sql = mysql_query("SELECT * FROM product JOIN brand ON product.brand_id = brand.brand_id LIMIT 3");
                $num = mysql_num_rows($sql);
